...
//                    }
        ...
        if ($this->type == 'raffle') {
            ...
            foreach ($res as $row) {
                ...
                if (Gateways::enabled('credits') && getSetting('credits_only', 'value2') == 0 && ($price == 0 || $credits == 0)
                    || Gateways::enabled('credits') && getSetting('credits_only', 'value2') == 1 && $credits == 0
    ...
    public static function sale($id, $sale_ar = null, $perc = null)
    {
        ...
        if ($sale_ar != null && in_array($id, $sale_ar, true) && $valid_date && $sale_end > new datetime()) {
            return true;
        } else {
            return false;
        }
