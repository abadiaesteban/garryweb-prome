...
class gateways
{
    ...
    public function display()
    {
        ...
        if ($type == 'pkg') {
            ...
            if (Gateways::enabled('credits') && getSetting('credits_only', 'value2') === 0 && ($price === 0 || $credits === 0 && $custom_price === 0)
                || Gateways::enabled('credits') && getSetting('credits_only', 'value2') === 1 && $credits === 0 && $custom_price === 0
                || !Gateways::enabled('credits') && $price === 0 && $custom_price === 0) {
                $free = true;
            }
