...
class credits
{
    public static function hasEnough($uid, $pkg, $type, $coupon = false, $receiver_uid = null, $price = null)
    {
        global $db;
    ...
    public static function withdraw($uid, $pkg, $type, $coupon = false, $receiver_uid = null, $price = null)
    {
        global $db;
